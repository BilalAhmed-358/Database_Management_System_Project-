...
insert into CUSTOMERS VALUES('10','HAMEEZ','johar'),
('20','BILAL','SHAHLATIF'),
('30','FAST','BHAINS COLONY');
...
alter table containers add column shipid VARCHAR(10) NOT NULL UNIQUE;
...
insert into SHIPS VALUES('110','SEA','KARACHI',CURTIME(),4,1000,60,200,CURDATE(),10);

alter table CUSTOMERS add column CUSTPASSWORD varchar(10) not null;
alter table admin add column ADMINPASSWORD varchar(10) not null;

ALTER TABLE ADMINS DROP COLUMN PORTID;